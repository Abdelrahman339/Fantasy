...
protected:
	...
	void static UpdateFootballerPoints(queue<Game> UserGames, list<Game> CurrentGame); // updating all the players in a User Game
	void static UpdateAllPlayersPoints(list<Game>CurrenGame);// updating all the players points in that round
