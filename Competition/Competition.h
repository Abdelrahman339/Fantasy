...
protected:
	...
	void static UpdateFootballerPrice(Footballer& player);
	bool IsManOfTheMatch(Game& currentGame, Footballer& player);//Checks if the player is the MOTM
	//based on points for EVERY player (even if not in user's squad)
