...
public:
	...
	void static searchTeamInMatch(unordered_map<string, Footballer>& TeamType, Game game, HighlightsOfTheMatch Highlights); //for looping over the hometeam and awayteam 
