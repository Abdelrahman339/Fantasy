...
public:
	...
	map<string, HighlightsOfTheMatch> static parseHighlights(vector<string> highlights, int gameId, string regex);
	map<string, HighlightsOfTheMatch> static getHighlights(int gameID);
};